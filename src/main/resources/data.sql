INSERT INTO `country` (id, name, code, regex) VALUES (1001,'Cameroon', '+237', '\(237\)\ ?[2368]\d{7,8}$');
INSERT INTO `country` (id, name, code, regex) VALUES (1002,'Ethiopia', '251', '\(251\)\ ?[1-59]\d{8}$');
INSERT INTO `country` (id, name, code, regex) VALUES (1003,'Morocco', '+212', '\(212\)\ ?[5-9]\d{8}$');
INSERT INTO `country` (id, name, code, regex) VALUES (1004,'Mozambique', '+258', '\(258\)\ ?[28]\d{7,8}$');
INSERT INTO `country` (id, name, code, regex) VALUES (1005,'Uganda', '+256', '\(256\)\ ?\d{9}$');
...
INSERT INTO `customer` (id, name, phone) VALUES(8,'Wallas Singz Junior','(258) 846565883');
